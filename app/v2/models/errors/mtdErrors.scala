...
object FormatAdjustmentValueError extends MtdError("FORMAT_ADJUSTMENT_VALUE", "Format bad")
...
object RuleAdjustmentRangeInvalid extends MtdError("RULE_RANGE_INVALID", "Range bad")
