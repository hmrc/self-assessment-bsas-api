...
package v6.selfEmploymentBsas.retrieve.def2
...
import v6.selfEmploymentBsas.retrieve.def2.model.request.Def2_RetrieveSelfEmploymentBsasRequestData
import v6.selfEmploymentBsas.retrieve.model.request.RetrieveSelfEmploymentBsasRequestData

object Def2_RetrieveSelfEmploymentBsasValidator extends ResolverSupport {
  private val resolveTaxYear = ResolveTaxYear.resolver
}

class Def2_RetrieveSelfEmploymentBsasValidator(
    nino: String,
    calculationId: String,
    taxYear: String
) extends Validator[RetrieveSelfEmploymentBsasRequestData] {

  import Def2_RetrieveSelfEmploymentBsasValidator.*
  ...
  def validate: Validated[Seq[MtdError], RetrieveSelfEmploymentBsasRequestData] =
    ...
    ).mapN(Def2_RetrieveSelfEmploymentBsasRequestData.apply)
