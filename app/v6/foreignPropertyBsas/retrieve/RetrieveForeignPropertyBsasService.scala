...
class RetrieveForeignPropertyBsasService @Inject() (connector: RetrieveForeignPropertyBsasConnector) extends BaseRetrieveBsasService {
  ...
  protected val supportedTypesOfBusiness: Set[TypeOfBusinessWithFHL] = Set(TypeOfBusinessWithFHL.`foreign-property`, TypeOfBusinessWithFHL.`foreign-property-fhl-eea`)
