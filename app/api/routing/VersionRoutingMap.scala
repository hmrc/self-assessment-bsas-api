...
case class VersionRoutingMapImpl @Inject() (defaultRouter: Router, v7Router: v7.Routes) extends VersionRoutingMap {

  val map: Map[Version, Router] = Map(Version7 -> v7Router)
