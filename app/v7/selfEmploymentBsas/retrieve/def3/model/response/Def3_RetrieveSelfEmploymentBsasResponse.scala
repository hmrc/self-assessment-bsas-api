...
case class Def3_RetrieveSelfEmploymentBsasResponse(
    metadata: Metadata,
    inputs: Inputs,
...
object Def3_RetrieveSelfEmploymentBsasResponse {

  implicit val reads: Reads[Def3_RetrieveSelfEmploymentBsasResponse] = (
  ...
  )(Def3_RetrieveSelfEmploymentBsasResponse.apply)

  implicit val writes: OWrites[Def3_RetrieveSelfEmploymentBsasResponse] = Json.writes
}
