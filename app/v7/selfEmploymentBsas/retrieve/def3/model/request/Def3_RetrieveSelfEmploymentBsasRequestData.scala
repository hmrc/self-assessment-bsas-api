...
package v7.selfEmploymentBsas.retrieve.def3.model.request
...
case class Def3_RetrieveSelfEmploymentBsasRequestData(
    nino: Nino,
    calculationId: CalculationId,
    taxYear: TaxYear
) extends RetrieveSelfEmploymentBsasRequestData {

  val schema: RetrieveSelfEmploymentBsasSchema = RetrieveSelfEmploymentBsasSchema.Def3
}
