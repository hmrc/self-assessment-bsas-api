...
package v7.foreignPropertyBsas.retrieve.def3.model.request
...
case class Def3_RetrieveForeignPropertyBsasRequestData(
    nino: Nino,
    calculationId: CalculationId,
    taxYear: TaxYear
) extends RetrieveForeignPropertyBsasRequestData {

  val schema: RetrieveForeignPropertyBsasSchema = RetrieveForeignPropertyBsasSchema.Def3
