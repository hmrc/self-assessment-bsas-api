...
object Def3_RetrieveForeignPropertyBsasResponse {

  implicit val reads: Reads[Def3_RetrieveForeignPropertyBsasResponse] = (json: JsValue) =>
    for {
    ...
    } yield Def3_RetrieveForeignPropertyBsasResponse(
      metadata = metadata,
      inputs = inputs,
