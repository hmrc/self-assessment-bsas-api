...
object PropertyLevelDetail {

  implicit val emptinessChecker: EmptinessChecker[PropertyLevelDetail] = EmptinessChecker.use { body =>
    List(
  ...
  implicit val format: Format[PropertyLevelDetail] = Json.format[PropertyLevelDetail]
}
