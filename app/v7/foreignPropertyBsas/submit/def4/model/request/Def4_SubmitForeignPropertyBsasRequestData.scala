...
case class Def4_SubmitForeignPropertyBsasRequestData(
    nino: Nino,
    calculationId: CalculationId,
    taxYear: TaxYear,
    body: Def4_SubmitForeignPropertyBsasRequestBody
) extends SubmitForeignPropertyBsasRequestData {

  override val schema: SubmitForeignPropertyBsasSchema = SubmitForeignPropertyBsasSchema.Def4
