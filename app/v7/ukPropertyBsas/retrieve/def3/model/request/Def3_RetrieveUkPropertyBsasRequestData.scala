...
package v7.ukPropertyBsas.retrieve.def3.model.request
...
case class Def3_RetrieveUkPropertyBsasRequestData(
    nino: Nino,
    calculationId: CalculationId,
    taxYear: TaxYear
) extends RetrieveUkPropertyBsasRequestData {

  val schema: RetrieveUkPropertyBsasSchema = RetrieveUkPropertyBsasSchema.Def3
