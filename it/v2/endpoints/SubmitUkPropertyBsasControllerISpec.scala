    ...
    "return error according to spec" when {
      ...
      "des service error" when {
        ...
        val input = Seq(
          ...
          (FORBIDDEN, "INCOMESOURCE_TYPE_NOT_MATCHED", FORBIDDEN, RuleTypeOfBusinessError),
          (INTERNAL_SERVER_ERROR, "BVR_FAILURE_C55316", INTERNAL_SERVER_ERROR, DownstreamError),
          (INTERNAL_SERVER_ERROR, "BVR_FAILURE_C15320", INTERNAL_SERVER_ERROR, DownstreamError),
