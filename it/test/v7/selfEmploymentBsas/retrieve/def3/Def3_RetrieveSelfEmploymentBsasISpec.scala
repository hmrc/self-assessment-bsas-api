...
class Def3_RetrieveSelfEmploymentBsasISpec extends IntegrationBaseSpec {
    ...
    "return a valid response with status OK" when {
      "given a valid TYS request" in new Test {
        override def setupStubs(): Unit = {
          DownstreamStub.onSuccess(DownstreamStub.GET, downstreamUrl, OK, downstreamRetrieveBsasResponseJson(2027))
        }
