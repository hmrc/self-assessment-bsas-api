...
import v7.ukPropertyBsas.retrieve.def3.model.response.RetrieveUkPropertyBsasFixtures.*

class Def3_RetrieveUkPropertyBsasISpec extends IntegrationBaseSpec {
  ...
  "Calling the retrieve UK Property Bsas endpoint" should {
    ...
    "return error response with status BAD_REQUEST" when {
      "valid request is made but downstream response has invalid type of business" in new Test {
    ...
    "return error according to spec" when {
      ...
      val input = List(
        ("AA1123A", "f2fb30e5-4ab6-4a29-b3c1-c7264259ff1c", "2026-27", BAD_REQUEST, NinoFormatError),
        ("AA123456A", "f2fb30e5-4ab6-4a29-b3c1-beans", "2026-27", BAD_REQUEST, CalculationIdFormatError),
  ...
  private trait Test {
    ...
    def downstreamUri: String = s"/itsa/income-tax/v1/26-27/adjustable-summary-calculation/$nino/$calculationId"
    def setupStubs(): Unit
