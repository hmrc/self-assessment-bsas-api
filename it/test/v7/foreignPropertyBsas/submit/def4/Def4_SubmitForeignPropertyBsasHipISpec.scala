...
class Def4_SubmitForeignPropertyBsasHipISpec extends IntegrationBaseSpec with JsonErrorValidators {
  ...
  "Calling the submit foreign property bsas endpoint" should {
    ...
    "return error according to spec" when {
      ...
      val input = List(
        ("Walrus", "f2fb30e5-4ab6-4a29-b3c1-c7264259ff1c", "2026-27", mtdRequestForeignPropertyValid, BAD_REQUEST, NinoFormatError, None),
        ("AA123456A", "BAD_CALC_ID", "2026-27", mtdRequestForeignPropertyValid, BAD_REQUEST, CalculationIdFormatError, None),
        ...
        (
          ...
          BAD_REQUEST,
          RuleBothExpensesError.copy(paths = Some(List("/foreignProperty/propertyLevelDetail/0/expenses"))),
          None
        )
      )
