...
class Def3_RetrieveForeignPropertyBsasIfsISpec extends IntegrationBaseSpec {
  ...
  private trait TysTest extends Test {
    ...
    def downstreamUrl: String = s"/income-tax/adjustable-summary-calculation/26-27/$nino/$calculationId"
