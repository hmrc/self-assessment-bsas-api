...
class Def1_RetrieveForeignPropertyBsasHipISpec extends IntegrationBaseSpec {
  ...
  "Calling the retrieve Foreign Property Bsas HIP endpoint" should {
    ...
    "return error according to spec" when {
      ...
      val input = List(
        ("BAD_NINO", "bb9e053d-9c3a-4ccb-891e-89aebdbdbdc9", None, BAD_REQUEST, NinoFormatError),
        ("AA123456A", "bad_calc_id", None, BAD_REQUEST, CalculationIdFormatError),
        ("AA123456A", "bb9e053d-9c3a-4ccb-891e-89aebdbdbdc9", Some("2023"), BAD_REQUEST, TaxYearFormatError),
  ...
  private trait Test {
    val nino          = "AA678910B"
    val calculationId = "bb9e053d-9c3a-4ccb-891e-89aebdbdbdc9"
