...
import v6.foreignPropertyBsas.retrieve.def2.model.response.RetrieveForeignPropertyBsasBodyFixtures.{retrieveForeignPropertyBsasDesFhlJson, retrieveForeignPropertyBsasDesNonFhlJson, retrieveForeignPropertyBsasMtdFhlJson, retrieveForeignPropertyBsasMtdNonFhlJson}
import v6.selfEmploymentBsas.retrieve.def1.model.Def2_RetrieveSelfEmploymentBsasFixtures
