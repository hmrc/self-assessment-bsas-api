...
class Def3_RetrieveUkPropertyBsasValidatorSpec extends UnitSpec {
  ...
  private def validator(nino: String, calculationId: String, taxYear: String) =
    new Def3_RetrieveUkPropertyBsasValidator(nino, calculationId, taxYear)
    ...
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(
          Def3_RetrieveUkPropertyBsasRequestData(parsedNino, parsedCalculationId, parsedTaxYear)
        )
      }
