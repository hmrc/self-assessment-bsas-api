...
package v7.selfEmploymentBsas.submit.def1.model.request.fixtures

import play.api.libs.json.{JsObject, JsValue, Json}
import v7.selfEmploymentBsas.submit.def1.model.request.Def1_SubmitSelfEmploymentBsasRequestBody
import v7.selfEmploymentBsas.submit.def1.model.request.fixtures.AdditionsFixture._
import v7.selfEmploymentBsas.submit.def1.model.request.fixtures.ExpensesFixture._
import v7.selfEmploymentBsas.submit.def1.model.request.fixtures.IncomeFixture._
...
object SubmitSelfEmploymentBsasFixtures {
  ...
  val mtdRequestJson: JsValue = Json.parse(
    """
      ...
      |   "expenses":{
      |     "costOfGoods":2000.25,
      |     "paymentsToSubcontractors":2000.5,
      |     "wagesAndStaffCosts":2000.75,
      |     "carVanTravelExpenses":-2000.25,
      |     "premisesRunningCosts":-2000.5,
      |     "maintenanceCosts":-2000.75,
      |     "adminCosts":2001.25,
      |     "interestOnBankOtherLoans":-2001.25,
      |     "financeCharges":-2001.5,
      |     "irrecoverableDebts":-2001.75,
      |     "professionalFees":2002.25,
      |     "depreciation":2002.5,
      |     "otherExpenses":2002.75,
