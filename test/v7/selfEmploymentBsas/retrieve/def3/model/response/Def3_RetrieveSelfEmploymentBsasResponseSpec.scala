...
class Def3_RetrieveSelfEmploymentBsasResponseSpec extends UnitSpec with JsonErrorValidators with RoundTripTest {

  import Def3_RetrieveSelfEmploymentBsasResponse.*
