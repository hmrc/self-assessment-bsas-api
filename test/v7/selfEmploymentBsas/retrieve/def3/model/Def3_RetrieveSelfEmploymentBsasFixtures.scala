...
package v7.selfEmploymentBsas.retrieve.def3.model

import api.models.domain.{Source, Status}
import play.api.libs.json.{JsValue, Json}
import v7.common.model.{IncomeSourceType, TypeOfBusiness}
import v7.selfEmploymentBsas.retrieve.def3.model.response.*
import v7.selfEmploymentBsas.retrieve.model.response.RetrieveSelfEmploymentBsasResponse

object Def3_RetrieveSelfEmploymentBsasFixtures {

  private val now          = "2026-04-06"
  private val aYearFromNow = "2027-04-05"
  ...
  val downstreamSummaryCalculationDeductionsJson: JsValue = Json.parse(
    """
      ...
      |  "firstYearAllowanceOnPlantAndMachinery": 6.15
      |}
      |""".stripMargin
  )
  ...
  val summaryCalculationDeductions: SummaryCalculationDeductions = SummaryCalculationDeductions(
    ...
    firstYearAllowanceOnPlantAndMachinery = Some(6.15)
  )
  ...
  val retrieveBsasResponse: Def3_RetrieveSelfEmploymentBsasResponse = Def3_RetrieveSelfEmploymentBsasResponse(
  ...
  def retrieveBsasResponseInvalidTypeOfBusinessDataObject(incomeSourceType: String): RetrieveSelfEmploymentBsasResponse =
    Def3_RetrieveSelfEmploymentBsasResponse(
      metadata = parsedMetadata,
