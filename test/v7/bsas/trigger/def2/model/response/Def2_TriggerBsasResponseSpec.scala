...
package v7.bsas.trigger.def2.model.response

import play.api.libs.json.{JsError, Json}
import shared.utils.UnitSpec
import v7.bsas.trigger.model.TriggerBsasResponse

class Def2_TriggerBsasResponseSpec extends UnitSpec {

  val triggerBsasResponse: TriggerBsasResponse = Def2_TriggerBsasResponse("anId")
      ...
      "return the expected Def1_TriggerBsasResponse object" in {
        Json
          .parse("""
              ...
              |}
  """.stripMargin)
          .as[Def2_TriggerBsasResponse] shouldBe triggerBsasResponse
      }
    }
