...
package v7.bsas.trigger.def2.model

import play.api.libs.json.{JsValue, Json}
import play.api.mvc.AnyContentAsJson
import v7.bsas.trigger.def2.model.request.{AccountingPeriod, Def2_TriggerBsasRequestBody}
...
object Def2_TriggerBsasFixtures {
  ...
  val triggerBsasRequestBody: Def2_TriggerBsasRequestBody = Def2_TriggerBsasRequestBody(
    AccountingPeriod("2018-11-25", "2018-11-26"),
    TypeOfBusiness.`self-employment`.toString,
    "anId"
  )

  val tysTriggerBsasRequestBody: Def2_TriggerBsasRequestBody = Def2_TriggerBsasRequestBody(
    AccountingPeriod("2023-05-01", "2023-05-02"),
    TypeOfBusiness.`self-employment`.toString,
    "anId"
  )

  val responseObj: Def2_TriggerBsasResponse = Def2_TriggerBsasResponse("c75f40a6-a3df-4429-a697-471eeec46435")
