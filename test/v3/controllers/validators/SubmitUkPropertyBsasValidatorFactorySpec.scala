    ...
    "return the parsed domain object" when {
      ...
      "given a valid fhl request" in {
        ...
        result shouldBe Right(
          SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedFhlBody)
        )
      }
      ...
      "a valid TYS request is supplied" in {
        ...
        result shouldBe Right(
          SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, Some(parsedTaxYear), parsedFhlBody)
        )
      }
      ...
      "a valid non-fhl request is supplied" in {
        ...
        result shouldBe Right(
          SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedNonFhlBody)
        )
      }
      ...
      "a valid fhl consolidated expenses request is supplied" in {
        ...
        result shouldBe Right(
          SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedFhlConsolidatedBody)
        )
      }
      ...
      "a valid non-fhl consolidated expenses request is supplied" in {
        ...
        result shouldBe Right(
          SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedNonFhlConsolidatedBody)
        )
      }
      ...
      "a minimal fhl request is supplied" in {
        ...
        val parsedMinimal = minimalJson.as[SubmitUKPropertyBsasRequestBody]

        val result = validator(validNino, validCalculationId, None, minimalJson).validateAndWrapResult()
        result shouldBe Right(
          SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedMinimal)
        )
      }
