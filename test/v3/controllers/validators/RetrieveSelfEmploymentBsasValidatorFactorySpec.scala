...
class RetrieveSelfEmploymentBsasValidatorFactorySpec extends UnitSpec {
  ...
  val validatorFactory = new RetrieveSelfEmploymentBsasValidatorFactory
    ...
    "return the parsed domain object" when {
      "passed a valid non-TYS request" in {
        ...
        result shouldBe Right(
          RetrieveSelfEmploymentBsasRequestData(parsedNino, parsedCalculationId, None)
        )
      }
      ...
      "passed a valid TYS request" in {
        ...
        result shouldBe Right(
          RetrieveSelfEmploymentBsasRequestData(parsedNino, parsedCalculationId, Some(parsedTaxYear))
        )
      }
    }
