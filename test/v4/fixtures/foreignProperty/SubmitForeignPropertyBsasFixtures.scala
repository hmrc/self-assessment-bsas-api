...
import v4.models.request.submitBsas.foreignProperty.{
  FhlEea,
  FhlEeaExpenses,
  FhlIncome,
  ForeignProperty,
...
object SubmitForeignPropertyBsasFixtures {
  ...
  val requestNonFhlFullModel: SubmitForeignPropertyBsasRequestBody = SubmitForeignPropertyBsasRequestBody(
  ...
  val requestFhlFullModel: SubmitForeignPropertyBsasRequestBody = SubmitForeignPropertyBsasRequestBody(
