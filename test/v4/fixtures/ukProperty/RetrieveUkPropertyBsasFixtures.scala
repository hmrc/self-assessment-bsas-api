...
object RetrieveUkPropertyBsasFixtures {
  ...
  val retrieveBsasResponseFhlModel: RetrieveUkPropertyBsasResponse = RetrieveUkPropertyBsasResponse(
  ...
  val retrieveBsasResponseNonFhlModel: RetrieveUkPropertyBsasResponse = RetrieveUkPropertyBsasResponse(
    metadata = metadataModel,
  ...
  def retrieveBsasResponseInvalidTypeOfBusinessModel(typeOfBusiness: TypeOfBusiness): RetrieveUkPropertyBsasResponse = RetrieveUkPropertyBsasResponse(
    metadata = metadataModel,
