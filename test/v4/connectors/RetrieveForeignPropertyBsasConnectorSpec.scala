...
import v4.fixtures.foreignProperty.RetrieveForeignPropertyBsasBodyFixtures.parsedNonFhlRetrieveForeignPropertyBsasResponse
import v4.models.request.retrieveBsas.RetrieveForeignPropertyBsasRequestData
import v4.models.response.retrieveBsas.foreignProperty.RetrieveForeignPropertyBsasResponse
...
class RetrieveForeignPropertyBsasConnectorSpec extends ConnectorSpec {
  ...
  trait Test {
    _: ConnectorTest =>
    val connector: RetrieveForeignPropertyBsasConnector = new RetrieveForeignPropertyBsasConnector(http = mockHttpClient, appConfig = mockSharedAppConfig)
  }
