...
class NonFHLIncomeSpec extends UnitSpec {
  ...
  val modelWithNotProvidedValues: NonFHLIncome = NonFHLIncome(None,Some(1000.45),Some(1000.45),Some(1000.45))
  ...
  "NonFHLIncome" when {
    "read from valid JSON" should {
      "return the expected NonFHLIncome object" in {
        requestJson.validate[NonFHLIncome] shouldBe JsSuccess(modelWithNotProvidedValues)
      }
    }
