...
import v1.models.response.retrieveBsas.selfEmployment.RetrieveSelfAssessmentsAdjustmentHateoasData
  ...
  "retrieve" should {
    "return successful hateoas response for self-assessment with status OK" when {
      "a valid request supplied" in new Test {
        ...
        MockHateoasFactory
          .wrap(retrieveBsasResponseModelAdjusted, RetrieveSelfAssessmentsAdjustmentHateoasData(nino, bsasId))
