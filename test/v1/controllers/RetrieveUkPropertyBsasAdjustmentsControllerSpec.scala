...
class RetrieveUkPropertyBsasAdjustmentsControllerSpec extends ControllerBaseSpec
  ...
  "retrieve" when {
    "a valid request is supplied" should {
      ...
      "return successful hateoas response for uk-property-non-fhl with status OK for v1r5" in new Test(true) {
      ...
      "return successful hateoas response for uk-property-fhl with status OK for v1r5" in new Test(true) {
