...
object RetrieveBsasUKPropertyAdjustmentsFixtures {
  ...
  val retrieveUKPropertyAdjustmentResponseModel = RetrieveUKPropertyAdjustments(metaDataModel, bsasDetailModel)

  val minimalRetrieveUKPropertyAdjustmentResponseModel = RetrieveUKPropertyAdjustments(metaDataModel, BsasDetail(None, None))
}
