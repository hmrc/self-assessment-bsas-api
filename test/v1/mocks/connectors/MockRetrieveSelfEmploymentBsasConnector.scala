...
import v1.connectors.{DesOutcome, RetrieveSelfEmploymentBsasConnector}
...
trait MockRetrieveSelfEmploymentBsasConnector extends MockFactory {
  ...
  object MockRetrieveSelfEmploymentBsasConnector {
    ...
    CallHandler[Future[DesOutcome[RetrieveSelfEmploymentBsasResponse]]] = {
      (mockConnector
        .retrieveSelfEmploymentBsas(_: RetrieveSelfEmploymentBsasRequestData)(_: HeaderCarrier, _: ExecutionContext))
        .expects(requestData, *, * )
    }
  }
}
