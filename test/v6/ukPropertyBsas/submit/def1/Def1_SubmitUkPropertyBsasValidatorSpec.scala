  ...
  "running a validation" should {
    "return the parsed domain object" when {
      ...
      "a valid ukProperty request is supplied" in {
        ...
        result shouldBe Right(
          Def1_SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedUkPropertyBody)
        )
      }
      ...
      "a valid ukProperty consolidated expenses request is supplied" in {
        ...
        result shouldBe Right(
          Def1_SubmitUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None, parsedUkPropertyConsolidatedBody)
        )
      }
