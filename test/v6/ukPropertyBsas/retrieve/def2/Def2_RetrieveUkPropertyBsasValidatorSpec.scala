    ...
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(
          Def2_RetrieveUkPropertyBsasRequestData(parsedNino, parsedCalculationId, None)
        )
      }
      ...
      "passed a valid request with a tax year" in {
        ...
        result shouldBe Right(
          Def2_RetrieveUkPropertyBsasRequestData(parsedNino, parsedCalculationId, Some(parsedTaxYear))
        )
      }
    }
